  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      ...
      (() async {
        try {
          ...
          error.value = e.response!.statusCode;
        }
        try {
          final response =
    ...
    return Scaffold(
        ...
        body: error.value != 422
                                  ...
                                  child: Column(
                                    children: [
                                          ...
                                          authController
                                              ...
                                              ? smartmixList.value.progress !=
                                                  ...
                                                  : SnackbarHandler.errorToast(
                                                      " No card Schedule",
                                                      'Please Visit Later')
                                              : popupDialogRefer(context,
                                                  text:
                                                      "Your free trial period has expired. To continue, start your paid membership.",
                                      ...
                                      ProgressBar(
                                        ...
                                        numtext: smartmixList.value.openCards
                                            .toString(),
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      ProgressBar(
                                        ...
                                        numtext: categoryList
                                            .value[index].openCards
                                            .toString(),
            ...
            : Container(
                child: Center(child: Text("No cards for now")),
              ));
  }
}
