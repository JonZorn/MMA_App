...
class _SubscriptionScreenState extends State<SubscriptionScreen> {
  ...
  Widget build(BuildContext context) {
    final group = useState<IAPItem>(IAPItem.fromJSON({}));
                    ...
                    child: Card(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Padding(
                            padding: EdgeInsets.fromLTRB(scaler.scalerH(40.0),
    ...
    useEffect(() {
      ...
      purchaseUpdatedSubscription =
        ...
        authController.confirmSubscription(
          ...
          FlutterInappPurchase.instance
              .finishTransaction(productItem, isConsumable: false);
          popupDialog(context, text: "Payment Successful", onTap: () {
            Navigator.of(context).pop();
          });
        });
            ...
            children: [
              ...
              Padding(
                ...
                child: Click(
                    ...
                    onPressed: () {
                      print("-+----------->SubscriptionScreen PROCEED");
                      FlutterInappPurchase.instance
