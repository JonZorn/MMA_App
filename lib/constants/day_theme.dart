...
AppBar header(context, {String? text, void Function()? onTap}) {
  return AppBar(
      ...
      return AlertDialog(
        actions: [
          ...
          Align(
            ...
            child: Padding(
              padding: EdgeInsets.only(left: scaler.scalerH(15)),
              child: Text(
                title!,
                style: textStyle(
          ...
          SizedBox(height: scaler.scalerV(50)),
          Padding(
            padding: EdgeInsets.only(left: scaler.scalerH(140)),
            child: Row(
              children: [
                TextButton(
                    child: Text(no),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Padding(
                      padding: EdgeInsets.only(
                          top: scaler.scalerV(5),
                          left: scaler.scalerH(10),
                          right: scaler.scalerH(10)),
                      child: Text(
                        text!,
                        textAlign: TextAlign.center,
                        style: textStyle(
...
void showAlertDialogback(
  BuildContext context, {
  String title = " All Cards Done",
  String yes = "Ok",
  Function? onPressedYes,
}) {
  showDialog(
    ...
    builder: (BuildContext buildContext) {
      return AlertDialog(
        ...
        content: Text("Great, you have completed all the cards"),
        actions: [
          TextButton(
              child: Text(yes),
              onPressed: () {
